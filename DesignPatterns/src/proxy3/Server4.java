...
public class Server4 extends UnicastRemoteObject implements ServerInterface{
    ...
    public JOptionPaneArguments getJOptionPaneArguments() throws RemoteException {
        return new JOptionPaneArguments(null, new JLabel(new ImageIcon(getClass().getResource("img4.png"))), "Server4: "+SERVER_STARTING_TIME, JOptionPane.PLAIN_MESSAGE, null);
    }
    public static void main(String[] args) {
        try {
            System.out.println("Starting Server...");
            ServerInterface server = new Server4();
