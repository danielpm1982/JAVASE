...
public class Server3 extends UnicastRemoteObject implements ServerInterface{
    ...
    public JOptionPaneArguments getJOptionPaneArguments() throws RemoteException {
        return new JOptionPaneArguments(null, new JLabel(new ImageIcon(getClass().getResource("img3.png"))), "Server3: "+SERVER_STARTING_TIME, JOptionPane.PLAIN_MESSAGE, null);
    }
    public static void main(String[] args) {
        try {
            System.out.println("Starting Server...");
            ServerInterface server = new Server3();
            System.out.println("Server started! At: "+SERVER_STARTING_TIME);
            System.out.println("Binding Stub to the RMI registry...");
            Naming.rebind("server3", server);
