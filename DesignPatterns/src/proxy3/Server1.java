...
public class Server1 extends UnicastRemoteObject implements ServerInterface{
    ...
    public JOptionPaneArguments getJOptionPaneArguments() throws RemoteException {
        return new JOptionPaneArguments(null, new JLabel(new ImageIcon(getClass().getResource("img1.png"))), "Server1: "+SERVER_STARTING_TIME, JOptionPane.PLAIN_MESSAGE, null);
    }
    public static void main(String[] args) {
        try {
            System.out.println("Starting Server...");
            ServerInterface server = new Server1();
