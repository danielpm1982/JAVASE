...
public class Polinomio {
    ...
    public Polinomio(double... arrayCoeficiente) throws GrauNegativoException, GrauZeroException{
        ...
        if(GRAU<0){
            throw new GrauNegativoException(null, null, GRAU);
        } else if(GRAU==0){
            throw new GrauZeroException(null, null, GRAU);
        }
    }
