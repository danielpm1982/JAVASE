...
public class SelectionSortTest {
    public static void test(){
        ...
        SelectionSort.sort(array); //O(n^2)
        long timeFinal = System.nanoTime();
        long timeResult1 = timeFinal-timeInitial;
        System.out.println(Arrays.toString(array));
        System.out.println("Sorted in "+timeResult1+" nanoseconds using SelectionSort method.");
        System.out.println("");
        ...
        System.out.println("\nQuickSort took "+(float)timeResult2/timeResult1+" of SelectionSort time to sort the array.");
        System.out.println("");
    }
}
